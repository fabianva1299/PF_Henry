    ...
    <main className="min-h-screen bg-gray-950 text-white">
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        ...
        <div className="mt-12 grid items-center gap-12 lg:grid-cols-[0.7fr_1.3fr]">
          <div>
            ...
            <p className="mt-6 text-lg text-indigo-200/65">
              VECTOR AUTORREGRESIVO DEL PIB DE USA Y AUSTRALIA
            </p>
        ...
        <section className="mt-24">
          <h2 className="text-3xl font-semibold">Acerca de mi Proyecto</h2>

          <p className="mt-4 max-w-3xl text-indigo-200/65">
            El análisis utiliza un modelo de vectores autorregresivos (VAR) 
            para estudiar la relación dinámica entre el PIB de Estados Unidos 
            y Australia durante el periodo 1970-2000.
          </p>
        </section>
      </section>
    </main>
