      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        ...
        <section className="mt-24">
          ...
          <p className="mt-4 max-w-3xl text-indigo-200/65">
            El análisis econométrico examina cómo la educación, la experiencia, las horas trabajadas 
            y diversas características personales y geográficas influyen en el salario.
          </p>
        </section>
      </section>
    </main>
