  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        data-aos-delay={200}
      >
        <figure className="relative mx-auto max-w-md overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-linear-to-br before:from-gray-900 before:via-indigo-500/20 before:to-gray-900">
          <Image
            src={thumb}
            width={thumbWidth}
            height={thumbHeight}
